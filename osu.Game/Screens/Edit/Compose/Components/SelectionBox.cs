...
namespace osu.Game.Screens.Edit.Compose.Components
{
    public class SelectionBox : CompositeDrawable
    {
        ...
        {
            addButton(FontAwesome.Solid.ArrowsAltV, "水平翻轉 (Ctrl-J)", () => OnFlip?.Invoke(Direction.Vertical));
        ...
        {
            addButton(FontAwesome.Solid.ArrowsAltH, "垂直翻轉 (Ctrl-H)", () => OnFlip?.Invoke(Direction.Horizontal));
