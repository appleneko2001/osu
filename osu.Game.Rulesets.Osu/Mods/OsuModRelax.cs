...
namespace osu.Game.Rulesets.Osu.Mods
{
    ...
    {
        public override string Description => @"自動點擊模式. 你什麼都不需要按! 只需要移動光標瞄準即可!"; //@"You don't need to click. Give your clicking/tapping fingers a break from the heat of things.";
